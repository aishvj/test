			...
			<div class="row">
							...
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-4">
										...
										<h6><?php echo $value['quantity'] ?></h6>
									</td>
									<td class="column-5">$ <?php echo $value['quantity']*$value['item_price'] ?></td>
								</tr>
								<?php }
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<?php  if($total!=0){?>
						<button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" type="submit" onclick="location.href = 'handler/paypal.php'" name="placeorder">
							Place Order
						</button>
						<?php }else{ echo "please add to cart for shopping";}?>
					</form>
					</div>
				</div>
			</div>
